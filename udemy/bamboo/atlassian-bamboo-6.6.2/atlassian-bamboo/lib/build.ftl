...
[#-- @ftlvariable name="artifactDefinitions" type="java.util.List<com.atlassian.bamboo.plan.artifact.ArtifactDefinition>" --]
    ...
    <table id="artifactDefinitions" class="aui tablesorter">
        ...
        <tr>
            ...
            <th>[@ww.text name='artifact.build.dependency'/]</th>
            [#if showOperations]
                <th class="artifactDefinitionOperations">[@ww.text name='global.heading.actions'/]</th>
            [/#if]
        </tr>
        </thead>
        <tbody>
            ...
            <tr id="artifactDefinition-${artifact.id}">
                <td>
                    ...
                    [/#if]
                    <span class="artifactName">${artifact.name}</span>
                </td>
                <td>${artifact.location!}</td>
                <td>${artifact.copyPattern}</td>
                <td>
                    [#if artifact.required]
                        [@ui.lozenge textKey='artifact.required' titleKey='artifact.required.description'/]
                    [/#if]
                </td>
                [#if showOperations]

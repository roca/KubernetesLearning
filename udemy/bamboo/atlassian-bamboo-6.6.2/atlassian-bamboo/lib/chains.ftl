        ...
        <script type="text/javascript">
            ...
            var updateStage = function (data) {
                ...
                var newTitleHTML = data.stage.description ?
                        '<span class="stage-name">' + data.stage.name
                        +'</span> <span class="stage-description">'
                        + data.stage.description
                        +'</span>' :
                        '<span class="stage-name">' + data.stage.name + '</span>';
        ...
        <dl class="stageListGroup">
            <dt>
                ...
                [#if description?has_content]
                    <span class="stage-description">${description?html}</span>
                [/#if]
                [#if finalStage]
                    [@ui.lozenge text="final" /]
                [/#if]
                [#if manual]
                    [@ui.icon type='stage-manual' textKey="stage.manual.icon.description"/]
                [/#if]
            </dt>
            <dd>${status}</dd>
        </dl>

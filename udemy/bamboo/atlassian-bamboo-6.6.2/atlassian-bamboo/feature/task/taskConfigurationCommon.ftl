...
[#macro editTasksCommon taskSelectorUrl agentAvailabilityDescriptionUrl editTaskUrl deleteTaskUrl moveTaskUrl moveFinalBarUrl]
        ...
        <div id="panel-editor-list">
            ...
            <ul>
                [#list existingTasks as taskDef]
                    [@taskListItem
                        id=taskDef.id
                        name=taskDef.name!?html
                        editTaskUrl=editTaskUrl
                        deleteTaskUrl=deleteTaskUrl
                        description=taskDef.userDescription!?html
                        enabled=taskDef.enabled
                        conditional=taskDef.conditional
                        valid=taskDef.valid!true
                    /]
                [/#list]
                ...
                [#list finalisingTasks as taskDef]
                    [@taskListItem
                        ...
                        deleteTaskUrl=deleteTaskUrl
                        description=taskDef.userDescription!?html
                        enabled=taskDef.enabled final=true
                        valid=taskDef.valid!true
                    /]
                [/#list]
    ...
    <script type="text/x-template" title="lozengeConditional-template">
        [@ui.lozenge colour="default-subtle" textKey="tasks.conditional.label"/]
    </script>
    ...
    <script type="text/javascript">
        BAMBOO.TASKS.tasksConfig.init({
              ...
              templates: {
                  ...
                  lozengeConditional: "lozengeConditional-template",
...
[#macro taskListItem id name editTaskUrl deleteTaskUrl description="" enabled=true conditional=false final=false valid=true]

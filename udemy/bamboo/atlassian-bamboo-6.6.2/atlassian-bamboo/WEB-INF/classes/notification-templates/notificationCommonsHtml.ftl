...
[#macro notificationTitleSpecError baseUrl]
    <div id="title-status" class="failed">
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td id="title-status-icon">
                    <img src="${baseUrl}/images/iconsv4/icon-build-spec-failure-w.png" alt="Bamboo Specs failed">
                </td>
                <td id="title-status-text">
...
<div id="title-status" class="successful">
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td id="title-status-icon">
                <img src="${baseUrl}/images/iconsv4/icon-build-spec-success-w.png" alt="Bamboo Specs successful">
            </td>
            <td id="title-status-text">
                ...
                <tr  [#if build.isRssMissingAnyAccess()]class="all-spec-failed-builds__missing-permissions"[/#if]>
                    ...
                    <td class="all-spec-failed-builds__build">
                        [#if build.buildNumber??]
                            <a href="${baseUrl}/browse/${build.planKey.key}-${build.buildNumber}"><img src="${baseUrl}/images/iconsv4/icon-build-spec-failure.png" alt="Specs failed">#${build.buildNumber}</a>
                        [/#if]
                    </td>
                </tr>

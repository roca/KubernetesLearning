...
[#--
    ...
    @optional titleKey - i18n key to be used as title property, if empty then text or textKey used as title
--]
[#macro lozenge colour="default" text="" textKey="" showTitle=true subtle=false titleKey=""]
[#assign title][#if titleKey != ''][@s.text name=titleKey/][#else]${fn.resolveName(text, textKey)}[/#if][#t][/#assign]
